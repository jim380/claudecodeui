...
function ToolsSettings({ isOpen, onClose }) {
  ...
  const fetchMcpServers = async () => {
    try {
      ...
      const projectPath = window.location.pathname.includes("/project/")
        ? decodeURIComponent(window.location.pathname.split("/project/")[1])
        : "";

      const configResponse = await fetch(
        `/api/mcp/config/list?projectPath=${encodeURIComponent(projectPath)}`,
        {
          headers: {
                      ...
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex items-center gap-2 ml-4">
                            ...
                            <Button
                              onClick={() =>
                                handleMcpToolsDiscovery(server.id, server.scope)
                              }
                              variant="ghost"
                              size="sm"
                        ...
                        <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <Button
                              ...
                              disabled={
                                mcpConfigTesting || !mcpFormData.name.trim()
                              }
                              variant="outline"
                              size="sm"
